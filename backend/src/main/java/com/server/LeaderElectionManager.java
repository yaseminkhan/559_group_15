...
public class LeaderElectionManager {
    ...
    public void checkLeaderStatus() {
        // No need for an election if you are the leader 
        if (isLeader) {
            System.out.println("This server is the leader. No need to check.");
            return;
        }
    ...
    private int getServerId(String address) {
        if (!WebServer.serverAddressToIdMap.containsKey(address)) {
            System.err.println("ERROR: No ID found for address: " + address);
        }
