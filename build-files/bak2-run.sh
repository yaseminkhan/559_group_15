#/bin/bash
# This script is used to run backup 2
...
mvn exec:java -Dexec.mainClass="com.server.WebServer" -Dexec.args="8889 7001 ${PRIMARY_SERVER_IP}:5001,${BACKUP_SERVER_1_IP}:6001,${BACKUP_SERVER_3_IP}:4001 false"
